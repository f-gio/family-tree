...
assert.match(app, /data-remove-partner[^>]+type="button"|type="button"[^>]+data-remove-partner/);
assert.match(app, /data-remove-child[^>]+type="button"|type="button"[^>]+data-remove-child/);
